...
$(document).ready(function () {
    ...
    "use strict";
        ...
        function addMessage(message, self) {
            ...
            ;
            var $messageBubble = $("<div/>" + (self ? '<img src="images/resources/pr2.jpg" alt="">' : '<img src="images/resources/pr1.jpg" alt="">'))
        ...
        function sendMessage() {
            ...
            if (Math.random() < 0.65 || lastMessage.indexOf("?") > -1 || messages == 1)
                getReply();
        }

        function getReply() {
            if (incomingMessages > 2)
                return;
            incomingMessages++;
